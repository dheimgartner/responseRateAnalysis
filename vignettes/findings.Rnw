...
convert_flag <- function(x) {
  ...
  flag. <- stringr::str_replace_all(flag, "^yes", "R")
  flag.. <- stringr::str_replace_all(flag., "^no", "NR")
  flag... <- stringr::str_replace_all(flag.., "yes$", "I")
  flag.... <- stringr::str_replace_all(flag..., "no$", "NI")
  flag..... <- stringr::str_replace_all(flag...., "_", "x")
  flag.....
}
@
